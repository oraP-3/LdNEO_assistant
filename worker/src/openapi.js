...
const normalizedInput = {
  ...
  properties:{ schemaVersion, handTileIds:stringIdArray, visibleTileIds:stringIdArray, thoughtTileIds:stringIdArray, disabledRoleIds:stringIdArray, customRoles:{ type:'array', items:{ type:'object', properties:{}, additionalProperties:true } }, isOya:{ type:'boolean' } },
  additionalProperties:false
};
  ...
  return {
    ...
    components:{
      ...
      schemas:{
        ...
        AnalysisRequest:{ type:'object', required:['schemaVersion','handTileIds'], properties:{ schemaVersion, handTileIds:{ type:'array', minItems:8, maxItems:9, uniqueItems:true, description:'8または9枚のみ有効です。', items:{ type:'string' } }, visibleTileIds:stringIdArray, thoughtTileIds:stringIdArray, disabledRoleIds:stringIdArray, customRoles:{ type:'array', items:{ type:'object', properties:{}, additionalProperties:true } }, isOya:{ type:'boolean' } }, additionalProperties:false },
        ...
        SeriesComposition:{ type:'object', properties:{}, additionalProperties:{ $ref:'#/components/schemas/SeriesCompositionEntry' } },
